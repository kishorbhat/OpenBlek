...
//Draw the pattern in black color.
...
//Provide an erasing effect to the drawn pattern.
void drawWhiteLines(int x)
{
    glBegin(GL_LINE_STRIP);
...
//Decide and draw the right circles.
void drawCircles()
{
